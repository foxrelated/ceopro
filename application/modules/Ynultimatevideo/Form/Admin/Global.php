...
class Ynultimatevideo_Form_Admin_Global extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Text', 'ynultimatevideo_ffprobe_path', array(
            'label' => 'Path to ffprobe binary',
            'description' => 'Please enter the full path to your ffprobe binary file. (Environment variables are not present). This tools is required to get video orientation.',
            'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('ynultimatevideo.ffprobe.path', ''),
        ));
