...
<?php
    ...
    $this->headScript()
    ->appendFile($staticBaseUrl . 'application/modules/Ynultimatevideo/externals/scripts/jquery.js')
    ->appendScript('jQuery.noConflict();')
    ->appendFile($staticBaseUrl . 'application/modules/Ynultimatevideo/externals/scripts/js/vendor/jquery.ui.widget.js')
    ->appendFile($staticBaseUrl . 'application/modules/Ynultimatevideo/externals/scripts/js/jquery.iframe-transport.js')
    ->appendFile($staticBaseUrl . 'application/modules/Ynultimatevideo/externals/scripts/js/jquery.fileupload.js')
