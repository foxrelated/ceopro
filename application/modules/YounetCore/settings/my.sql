...
('core_admin_plugins_younet_core', 'younet-core', 'YouNetCo Core', '', '{"route":"admin_default","module":"younet-core","controller":"settings","action":"yours"}', 'core_admin_main_plugins', '',1 );
...
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
('younet_core_admin_main_younet', 'younet-core', 'YouNetCo Plugins', '', '{"route":"admin_default","module":"younet-core","controller":"settings","action":"younet"}', 'younet_core_admin_main', '',1 );
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
