...
class Advmenusystem_Form_Admin_Menu_ItemSubCreate extends Engine_Form
{
    public function init()
    {
        ...
        $this->addElement('Select', 'icon', array(
            ...
            'onchange' => 'updateIconType(this, "icon_class-wrapper")'
        ));

        $this->addElement('Text', 'icon_class', array(
            'label' => 'Icon Class',
        ));
        ...
        $this->addElement('Select', 'hover_active_icon', array(
            ...
            'multiOptions' => $logoOptions,
            'onchange' => 'updateIconType(this, "hover_active_icon_class-wrapper")'
        ));

        $this->addElement('Text', 'hover_active_icon_class', array(
            'label' => 'Hover/Active Icon Class',
        ));
