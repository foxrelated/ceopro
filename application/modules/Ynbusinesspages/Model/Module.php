           ...
           case 'poll':
            ...
            case 'classified':
                ...
                $option1 = array(
                    ...
                    'url' => $view->url(array('controller'=>'classified', 'action'=>'list', 'business_id'=>$business_id), 'ynbusinesspages_extended', true)
                );
                array_push($options, $option1);
                break;
            ...
            case 'ynvideochannel_video':
                if ($business->isAllowed('video_create')) {
                    $option = array(
                        'title' => $view -> translate('Add Video'),
                        'url' => $view->url(array('action'=>'share-video', 'subject_id'=>$business_id, 'parent_type'=>'ynbusinesspages_business'), 'ynvideochannel_general', true)
                    );
                    array_push($options, $option);
                }
                $option1 = array(
                    'title' => $view -> translate('View Videos'),
                    'url' => $view->url(array('controller'=>'video-channel', 'action'=>'list', 'business_id'=>$business_id), 'ynbusinesspages_extended', true)
                );
                array_push($options, $option1);
                break;
        }
