...
class Ynbusinesspages_Model_DbTable_Business extends Engine_Db_Table
{
    ...
    {
        if (Engine_Api::_()->hasModuleBootstrap('ynlocationbased') && !isset($params['isManage']) && !isset($params['admin'])) {
            $params = Engine_Api::_()->ynlocationbased()->mergeWithCookie('ynbusinesspages', $params);
        }
