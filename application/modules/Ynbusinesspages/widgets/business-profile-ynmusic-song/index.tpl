	...
	<div class="ynbusinesspages-profile-header-right">
		<?php if( $this->paginator->getTotalItemCount() > 0 ): ?>
			<?php echo $this->htmlLink(array(
				...
				'tab' => $this->identity,
			), '<i class="ynicon yn-list-view"></i>'.$this->translate('View all Social Music Songs'), array(
				'class' => 'buttonlink'
			))
			?>
		<?php endif; ?>
		...
		<?php if ($this->canCreate):?>
			...
			), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create Social Music Songs'), array(
				'class' => 'buttonlink'
			))
			?>
		<?php endif; ?>
