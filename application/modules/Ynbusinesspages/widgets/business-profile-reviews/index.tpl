...
<?php if (!$this->my_review && ($this -> viewer -> getIdentity() > 0)) : ?>
    ...
    <?php echo $this->htmlLink(
        array(
            ...
            'tab' => $this->identity,
            'page' => $this->page
        ),'<i class="ynicon yn-plus-circle"></i>'.$this->translate('Write a Review'),
        array(
            ...
            <?php if ($this->my_review && ($this -> viewer -> getIdentity() > 0)) : ?>
                <div class="option_div">
                    <?php echo $this->htmlLink(
                            ...
                            $this->translate('<i class="ynicon yn-trash-o"></i>'),
                            array(
                                'class' => 'smoothbox',
                            )
                        )?>
                        ...
                        <?php echo $this->htmlLink(
                            ...
                            $this->translate('<i class="ynicon yn-pencil-square-o"></i>'),
                            array(
                                'class' => 'smoothbox'
                            )
                        )?>
