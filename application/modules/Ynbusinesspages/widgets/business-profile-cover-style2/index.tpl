<?php
	$this->headScript()
        ...
        ->appendFile("//maps.googleapis.com/maps/api/js?key=". Engine_Api::_() -> getApi('settings', 'core') -> getSetting('yncore.googleapi_key', 'AIzaSyB3LowZcG12R1nclRd9NrwRgIxZNxLMjgc')."&v=3.exp&sensor=true&libraries=places");
	$this->headLink()
...
function setFollow(option_id)
{
	new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            if (option_id == '0')
            {
            	$("ynbusinesspages_widget_cover_follow").set("html", '<i class="ynicon yn-arrow-right"></i> <?php echo $this -> translate("Follow Business");?>');
            ...
            {
            	$("ynbusinesspages_widget_cover_follow").set("html", '<i class="ynicon yn-arrow-right"></i> <?php echo $this -> translate("Un-follow Business");?>');
...
function setFavourite(option_id)
{
	new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            if (option_id == '0')
            {
            	$("ynbusinesspages_widget_cover_favourite").set("html", '<i class="ynicon yn-star"></i>  <?php echo $this -> translate("Favourite Business");?>');
            ...
            {
            	$("ynbusinesspages_widget_cover_favourite").set("html", '<i class="ynicon yn-star"></i>  <?php echo $this -> translate("Un-favourite Business");?>');
...
{
	$('ynbusinesspages_like_button').set('html', '<a><i class="ynicon yn-loading-icon-1"></i></a>')
	...
	new Request.JSON({
        ...
        onSuccess: function(responseJSON, responseText) {
        	...
        	{
            	html = '<a class="ynbusinesspages_liked" href="javascript:void(0);" onclick="unlike(\'<?php echo $this->subject()->getType()?>\', \'<?php echo $this->subject()->getIdentity() ?>\')"><i class="ynicon yn-heart"></i></a>';
...
function unlike(itemType, itemId)
{
	...
	new Request.JSON({
        ...
        onSuccess: function(responseJSON, responseText) {
        	if (responseJSON.status == true)
        	{
        		html = '<a href="javascript:void(0);" onclick="like(\'<?php echo $this->subject()->getType()?>\', \'<?php echo $this->subject()->getIdentity() ?>\')"><i class="ynicon yn-heart"></i></a>';
            	$("ynbusinesspages_like_button").set('html', html);
            	reloadOptionsWidget();
        	}            
        }
...
<div class="ynbusinesspages-profile-cover">	
	...
	<div class="ynbusinesspages-profile-header">
		...
		<div class="ynbusinesspages-profile-avatar">
	        ...
	        <div class="ynbusinesspages-profile-footer-stats ynbusinesspages-clearfix">
				...
				?>
				<div>					
					<i class="ynicon yn-user-group"></i> <?php echo $this->translate(array("ynbusiness_member", "members", $memberCount), $memberCount);?>
					<span> <?php echo $memberCount; ?></span>
				</div>
				<div>
					<i class="ynicon yn-arrow-right"></i> <?php echo $this->translate(array("ynbusiness_follower", "followers", $followerCount), $followerCount);?>
					<span><?php echo $followerCount; ?></span>
				</div>
				<div>
					<i class="ynicon yn-pencil-square-o"></i> <?php echo $this->translate(array("ynbusiness_review", "reviews", $reviewCount), $reviewCount);?>
		...
		<div class="ynbusinesspages-profile-slider">
			...
			<div class="ynbusinesspages-profile-slider-main">
				<div class="ynbusinesspages-profile-slider-main-close"><i class="ynicon yn-del"></i></div>				
				<div class="ynbusinesspages-profile-slider">
						<div id="ynbusinesspages-profile-slider" class="owl-carousel">
							<?php foreach ($this->covers as $photo):?>
								<div class="item">
									<img src="<?php echo $photo->getPhotoUrl();?>" alt="">
								</div>
							<?php endforeach;?>
						</div>
				</div>
		...
		<div class="ynbusinesspages-like-information">
			...
			<span id="ynbusinesspages_like_button">			
				<?php if( $this->subject()->likes()->isLike($this->viewer()) ): ?>				
			   		<a class="ynbusinesspages_liked" href="javascript:void(0);" onclick="unlike('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>')"><i class="ynicon yn-heart"></i></a>
				<?php else: ?>
			       <a href="javascript:void(0);" onclick="like('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>')"><i class="ynicon yn-heart"></i></a>
				<?php endif; ?>
			</span>
			<?php endif;?>	
		</div>
	...
	<div class="ynbusinesspages-profile-footer">
		<div class="ynbusinesspages-profile-footer-right">
            ...
            <div>
                <?php echo $this->htmlLink($this -> url(array('action' => 'claim-business', 'id' => $this->subject() -> getIdentity()), 'ynbusinesspages_general', true), $this->translate("<i class='ynicon yn-paper-plane'></i> Claim business"), array('class' => 'smoothbox'));?> 
            </div>
            <?php endif;?>
			...
			<?php if($this->subject()->status == 'unclaimed') :?>
                ...
                ;?>
		        <div>      
	               	 <a href="<?php echo $url?>"><i class="ynicon yn-print"></i> <?php echo $this->translate('Print Business')?></a>
		        </div>
			<?php endif;?>
			...
			<div class="ynbusinesspages-profile-footer-more-action">
				...
				<div class="ynbusinesspages-profile-footer-more-option">
                    ...
                    <!-- Follow Business -->
                    <div>
                        <a href="javascript:;" id="ynbusinesspages_widget_cover_follow" class="" title="<?php echo ($this->follow) ? $this -> translate("Un-follow Business") : $this -> translate("Follow Business")?>" onclick="<?php echo ($this->follow) ? "setFollow(0);" : "setFollow(1);"; ?>"><i class="ynicon yn-arrow-right"></i> <?php echo ($this->follow) ? $this -> translate("Un-follow Business") : $this -> translate("Follow Business")?></a>
                    </div>
                    <!-- Favourite Business -->
                    <div>
                        <a href="javascript:;" id="ynbusinesspages_widget_cover_favourite" class="" title="<?php echo ($this->favourite) ? $this -> translate("Un-favourite Business") : $this -> translate("Favourite Business")?>" onclick="<?php echo ($this->favourite) ? "setFavourite(0);" : "setFavourite(1);"; ?>"><i class="ynicon yn-star"></i>  <?php echo ($this->favourite) ? $this -> translate("Un-favourite Business") : $this -> translate("Favourite Business")?></a>
                    </div>
                     <?php endif;?>
                    <!-- share -->
                    <?php if($aShareButton):?>
                        <div>
                            <a class="<?php echo (!empty($aShareButton['class'])) ? $aShareButton['class'] : "";?>" href="<?php echo $this -> url($aShareButton['params'], $aShareButton['route'], array()); ?>" > 
                                <i class="ynicon yn-share"></i> <?php echo $this -> translate($aShareButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <?php if($aPromoteButton):?>
                        <div>
                            <a class="<?php echo (!empty($aPromoteButton['class'])) ? $aPromoteButton['class'] : "";?>" href="<?php echo $this -> url($aPromoteButton['params'], $aPromoteButton['route'], array()); ?>" > 
                                <i class="ynicon yn-bullhorn"></i> <?php echo $this -> translate($aPromoteButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <?php if($aInviteButton):?>
                        <div>
                            <a class="<?php echo (!empty($aInviteButton['class'])) ? $aInviteButton['class'] : "";?>" href="<?php echo $this -> url($aInviteButton['params'], $aInviteButton['route'], array()); ?>" > 
                                <i class="ynicon yn-user"></i> <?php echo $this -> translate($aInviteButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <?php if($aReportButton):?>
                        <div>
                            <a class="<?php echo (!empty($aReportButton['class'])) ? $aReportButton['class'] : "";?>" href="<?php echo $this -> url($aReportButton['params'], $aReportButton['route'], array()); ?>" > 
                                <i class="ynicon yn-warning-circle"></i> <?php echo $this -> translate($aReportButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <?php if($aMessageButton):?>
                        <div>
                            <a class="<?php echo (!empty($aMessageButton['class'])) ? $aMessageButton['class'] : "";?>" href="<?php echo $this -> url($aMessageButton['params'], $aMessageButton['route'], array()); ?>" > 
                                <i class="ynicon yn-envelope"></i> <?php echo $this -> translate($aMessageButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <?php if($aCheckInButton):?>
                        <div>
                            <a class="<?php echo (!empty($aCheckInButton['class'])) ? $aCheckInButton['class'] : "";?>" href="<?php echo $this -> url($aCheckInButton['params'], $aCheckInButton['route'], array()); ?>" > 
                                <i class="ynicon yn-map-marker"></i> <?php echo $this -> translate($aCheckInButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    <a class = "smoothbox <?php
                        ...
                        <i class="ynicon yn-star"></i> <?php echo $this -> translate($aFetureButton['label']) ?>
                    </a>
                    </div>
                    <?php endif;?>
                    ...
                    <a class = "<?php
                        ...
                        <i class="ynicon yn-dollar-o"></i> <?php echo $this -> translate($aMakePaymentButton['label']) ?>
                    </a>
                    </div>
                    <?php endif;?>
                    ...
                    <div>
                        ...
                        ?>" href="<?php echo $this -> url($aEditButton['params'], $aEditButton['route'], array()); ?>" > 
                            <i class="ynicon yn-pencil-square-o"></i> <?php echo $this -> translate($aEditButton['label']) ?>
                        </a>
                    </div>
                    <?php endif;?>
                    ...
                    ?>" href="<?php echo $this -> url($aOpenCloseButton['params'], $aOpenCloseButton['route'], array()); ?>" > 
                        <i class="ynicon yn-del-o-circle"></i> <?php echo $this -> translate($aOpenCloseButton['label']) ?>
                    </a>
                    </div>
                    <?php endif;?>
                    ...
                    <?php if($aDeleteButton) :?>
                        ...
                        <div>
                            ...
                            ?>" href="<?php echo $this -> url($aDeleteButton['params'], $aDeleteButton['route'], array()); ?>" > 
                                <i class="ynicon yn-trash-o"></i> <?php echo $this -> translate($aDeleteButton['label']) ?>
                            </a>
                        </div>
                    <?php endif;?>
                    ...
                    ?>" href="<?php echo $this -> url($aDashboardButton['params'], $aDashboardButton['route'], array()); ?>" > 
                        <i class="ynicon yn-gear"></i> <?php echo $this -> translate($aDashboardButton['label']) ?>
                    </a>
                    </div>
                    <?php endif;?>
                    ...
                    if($this->subject()->isAllowed('login_business')):
                        ...
                        if(!$businessId):?>
                            <div>
                                <a onclick="selectForSwitch('<?php echo $this->subject() -> getIdentity() ?>');" href="javascript:;"><i class="ynicon yn-sign-in"></i> <?php echo $this -> translate("Login As Business");?></a>
                        ...
                        <?php else:?>
                            <div>
                                <a href="<?php echo $this->url(array('action' => 'logout-business', 'business_id' => $this->subject()->getIdentity()),'ynbusinesspages_general'); ?>"><i class="ynicon yn-sign-out"></i> <?php echo $this -> translate("Logout of Business");?></a>
                            </div>
        ...
        <?php if ($this->subject()->getMainLocation(true)): ?>
            <div class="ynbusinesspages-profile-location">
              <i class="ynicon yn-map-marker"></i><span><?php echo $this->subject()->getMainLocation(); ?></span>
              &nbsp;
              <?php
              ...
              if($mainLocation)
              {
                echo $this->htmlLink(
                    ...
                    '<i class="ynicon yn-location-arrow"></i> '.$this->translate('Get Direction'),
...
<div class="layout_ynbusinesspages_business_profile_cover_style_mobile">
    <div class="ynbusinesspages-profile-cover">
		...
		<?php else: ?>
			<div id="ynbusinesspages-profile-slider" class="owl-carousel">
					<div class="item">
						<img src="<?php echo $this->baseUrl();?>/application/modules/Ynbusinesspages/externals/images/default_bussiness_featured.png" alt="">
					</div>
			</div>
		<?php endif;?>
	</div>
        ...
        <div class="ynbusinesspages-profile-footer ynbusinesspages-clearfix">
            <div class="ynbusinesspages-profile-footer-stats">
                ...
                ?>
                <div>
                    <span><i class="ynicon yn-user-group"></i> <?php echo $memberCount; ?></span>
                    <?php echo $this->translate(array("ynbusiness_member", "members", $memberCount), $memberCount);?>
                </div>
                <div>
                    <span><i class="ynicon yn-arrow-right"></i> <?php echo $followerCount; ?></span>
                    <?php echo $this->translate(array("ynbusiness_follower", "followers", $followerCount), $followerCount);?>
                </div>
                <div>
                    <span><i class="ynicon yn-pencil-square-o"></i> <?php echo $reviewCount; ?></span>
            ...
            <div class="ynbusinesspages-profile-footer-right">          
                ...
                <?php if ($this->viewer()->getIdentity() && $isShowMore):?>
                <div class="ynbusinesspages-profile-footer-more-action">
                    <span><i class="ynicon yn-arr-down-circle"></i></span>
                    <div class="ynbusinesspages-profile-footer-more-option">
                         <?php 
                            $aDashboardButton = $menu -> onMenuInitialize_YnbusinesspagesBusinessDashBoard();
                            $aOpenCloseButton = $menu -> onMenuInitialize_YnbusinesspagesOpenCloseBusiness();
