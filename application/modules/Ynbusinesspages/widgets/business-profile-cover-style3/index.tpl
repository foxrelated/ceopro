...
function setFollow(option_id)
{
	new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            if (option_id == '0')
            {
            	$("ynbusinesspages_widget_cover_follow").set("html", '<i class="ynicon yn-arr-right"></i> <?php echo $this -> translate("Follow Business");?>');
            ...
            {
            	$("ynbusinesspages_widget_cover_follow").set("html", '<i class="ynicon yn-arr-right"></i> <?php echo $this -> translate("Un-follow Business");?>');
...
function like(itemType, itemId)
{
	...
	new Request.JSON({
        ...
        onSuccess: function(responseJSON, responseText) {
        	...
        	{
            	html = '<a class="ynbusinesspages_liked" href="javascript:void(0);" onclick="unlike(\'<?php echo $this->subject()->getType()?>\', \'<?php echo $this->subject()->getIdentity() ?>\')"><i title="<?php echo $this -> translate('Liked');?>" class="ynicon yn-heart"></i></a>';
...
function unlike(itemType, itemId)
{
	...
	new Request.JSON({
        ...
        onSuccess: function(responseJSON, responseText) {
        	if (responseJSON.status == true)
        	{
        		html = '<a href="javascript:void(0);" onclick="like(\'<?php echo $this->subject()->getType()?>\', \'<?php echo $this->subject()->getIdentity() ?>\')"><i title="<?php echo $this -> translate('Like');?>" class="ynicon yn-heart"></i></a>';
            	$("ynbusinesspages_like_button").set('html', html);
            	reloadOptionsWidget();
        	}            
        }
		...
		<div class="ynbusinesspages-like-information">			
			...
			<span id="ynbusinesspages_like_button">			
				<?php if( $this->subject()->likes()->isLike($this->viewer()) ): ?>				
			   		<a class="ynbusinesspages_liked" href="javascript:void(0);" onclick="unlike('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>')"><i title="<?php echo $this -> translate('Liked');?>" class="ynicon yn-heart"></i></a>
				<?php else: ?>
			       <a href="javascript:void(0);" onclick="like('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>')"><i title="<?php echo $this -> translate('Like');?>" class="ynicon yn-heart"></i></a>
				<?php endif; ?>
			</span>
			<?php endif;?>	
		...
		<div class="ynbusinesspages-profile-footer ynbusinesspages-clearfix">
			<div class="ynbusinesspages-profile-footer-action">			
				...
				<div class="ynbusinesspages-profile-footer-more-action">
					<span>
						<i class="ynicon yn-arr-down-circle"></i>
