  ...
  public function init()
  {
	...
	//Category
	 $this->addElement('Select', 'category_id', array(
      ...
      'description' => '<a name="add_more_category" id="add_more_category" type="button" class="ynicon yn-plus-circle" href="javascript:void(0);" onclick="javascript:void(0)"></a>',
    ));
	...
	$this->addElement('Text', 'phone', array(
	    ...
	    'class' => 'btn_form_inline',
	    'description' => '<a name="add_more_phone" id="add_more_phone" type="button" class="ynicon yn-plus-circle" href="javascript:void(0);" onclick="javascript:void(0)"></a>',
    ));
	...
	$this->addElement('Text', 'fax', array(
	    ...
	    'class' => 'btn_form_inline',
	    'description' => '<a name="add_more_fax" id="add_more_fax" type="button" class="ynicon yn-plus-circle" href="javascript:void(0);" onclick="javascript:void(0)"></a>',
    ));
	...
	$this->addElement('Text', 'web_address', array(
	    ...
	    'class' => 'btn_form_inline',
	    'description' => '<a name="add_more_web_address" id="add_more_web_address" type="button" class="ynicon yn-plus-circle" href="javascript:void(0);" onclick="javascript:void(0)"></a>',
    ));
