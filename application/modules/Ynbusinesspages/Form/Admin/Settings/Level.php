    ...
    public function init() {
        ...
        if( !$this->isPublic() ) {
            ...
            $this->addElement('Radio', 'view', array(
                'label' => 'Allow Viewing of Business',
                'multiOptions' => array(
                    2 => 'Yes, allow users to view all businesses.',
                    1 => 'Yes, allow users to view their own businesses.',
                    0 => 'No, do not allow users to view their own businesses.'
                ),
