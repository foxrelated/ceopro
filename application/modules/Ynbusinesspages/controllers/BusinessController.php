...
class Ynbusinesspages_BusinessController extends Core_Controller_Action_Standard
{
	...
	public function transferAction()
	{
		...
		try
		{
			...
			*/
			...
			$notifyApi -> addNotification($member, $user, $business, 'ynbusinesspages_transfer_owner');
    ...
    public function loadMorePhotosAction(){
	    ...
	    $this->view->currentPage = $currentPage = $this->_getParam('page', 1);
	    $itemCountPerPage = $this->_getParam('itemCountPerPage', 8);
	    // Get paginator
	    $album = $subject->getSingletonAlbum();
	    $this->view->view_mode = $this->_getParam('view_mode', 'grid');
