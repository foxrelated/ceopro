...
class Ynbusinesspages_IndexController extends Core_Controller_Action_Standard {
	...
	public function createStepTwoAction() {
		...
		// Validate Element: short_description must be less than 500 characters
		$validate_short_description = strip_tags($values['short_description']);
		if (strlen($validate_short_description) > 500) {
			$form -> short_description -> addError('The Short Description must be less than 500 characters.');
			return;
		}
	...
	public function loginAsBusinessAction()
	{
		...
		if (!$this -> getRequest() -> isPost()) 
		{
			...
			$select = $table -> getBusinessesSelect();
