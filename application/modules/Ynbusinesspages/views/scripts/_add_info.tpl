<?php
	...
	$editorOptions['plugins'] =  array(
		   		'table', 'fullscreen', 'media', 'preview', 'paste', 'link',
...
<?php endif;?>
	<div id="header_1-wrapper" class="form-wrapper">
		...
		<div id="header_1-element" class="form-element">
			...
			<a href="javascript:void(0);" onclick="javascript:void(0)" class='ynicon yn-plus-circle' id='add_more_info'></a>
		</div>
	</div>
	<div id="content_1-wrapper" class="form-wrapper">
		...
		<div id="content_1-element" class="form-element">
			...
			<script type="text/javascript">
				tinymce.init({ mode: "exact", elements: "content_1", plugins: "table,fullscreen,media,preview,paste,code,image,textcolor,link", theme: "modern", menubar: false, statusbar: false, toolbar1: "undo,|,redo,|,removeformat,|,pastetext,|,code,|,media,|,image,|,link,|,fullscreen,|,preview", toolbar2: "fontselect,fontsizeselect,bold,italic,underline,strikethrough,forecolor,backcolor,|,alignleft,aligncenter,alignright,alignjustify,|,bullist,numlist,|,outdent,indent,blockquote", toolbar3: "", element_format: "html", height: "225px", convert_urls: false, language: "en", directionality: "<?php echo ($this->layout()->orientation == 'right-to-left') ?  'rtl' : 'ltr' ?>" });
			</script>
		</div>
	</div>	
<?php if(!empty($this -> info)) :?>
