...
<div class="ynbusinesspages-profile-module-header">
    ...
    <div class="ynbusinesspages-profile-header-right">
	    <?php echo $this->htmlLink(array('route' => 'ynbusinesspages_profile', 'id' => $this->business->getIdentity()), '<i class="ynicon yn-arrow-left"></i>'.$this->translate('Back to Business'), array(
	    'class' => 'buttonlink'
	  )) ?>
	 	<?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'file', 'action'=>'list', 'business_id' => $this->business->getIdentity()), '<i class="ynicon yn-arrow-left"></i>'.$this->translate('Back to File Folders'), array(
	    'class' => 'buttonlink'
	  )) ?>
    </div>      
