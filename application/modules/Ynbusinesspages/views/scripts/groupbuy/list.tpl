        ...
        <div class="ynbusinesspages-profile-module-header">
            ...
            <div class="ynbusinesspages-profile-header-right">
                ...
                <?php if ($this->canCreate):?>
                    ...
                    ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Post A New Deal'), array(
                    'class' => 'buttonlink'
                    ))
                    ?>
                <?php endif; ?>
                ...
                <div class="ynbusinesspages-profile-module-option">
                    ...
                    <?php if ($canEdit): ?>
                        ...
                        array(
                            ...
                            'parent_type' => 'ynbusinesspages_business',
                        ), '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Deal'), array(
                            'class' => 'buttonlink',
                        ))
                        ?>
                    <?php endif; ?>
                    <?php if ($canDelete): ?>
                        ...
                        '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Deal'),
                    ...
                    <?php if ($canPublish): ?>
                        ...
                        '<i class="ynicon yn-cloud-upload"></i>'.$this->translate('Publish Deal'),
                    ...
                    '<i class="ynicon yn-del"></i>'.$this->translate('Delete Deal To Business'),
                    array('class'=>'buttonlink smoothbox'))
                    ?>
                    <?php endif; ?>  
                    <?php endif; ?>
