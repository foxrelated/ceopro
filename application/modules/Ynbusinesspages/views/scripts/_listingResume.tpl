...
<div class="ynresume-layout-header">
	<div id="ynresume-mode-view-<?php echo $this->idName;?>" class="ynresume-modeview-button">
		<?php if(in_array('list', $this -> mode_enabled)):?>
			<span class="" rel="ynresume-layout-content-list-view"><i class="ynicon yn-list-view"></i></span>
		<?php endif;?>
		<?php if(in_array('grid', $this -> mode_enabled)):?>
			<span class="" rel="ynresume-layout-content-grid-view"><i class="ynicon yn-th-block"></i></span>
		<?php endif;?>	
		<?php if(in_array('map', $this -> mode_enabled)):?>
			<span class="" rel="ynresume-layout-content-map-view"><i class="ynicon yn-map-marker"></i></span>
		<?php endif;?>	
	</div>
</div>
			...
			<div class="ynresume-layout-list-item">
	            ...
	            <div class="ynresume-layout-list-item-main">
	                ...
	                <div class="ynresume-layout-list-item-subline">
	                    <span><i class="ynicon yn-briefcase"></i><?php echo $resume->getJobTitle();?></span>
	                    <span><i class="ynicon yn-building"></i><?php echo $resume->getCompany();?></span>
	                </div>
	                <div class="ynresume-layout-list-item-subline">
	            ...
	            <div class="ynresume-layout-list-item-footer">
	                <?php if($viewer -> isSelf($resume -> getOwner())) :?>
	                	<div><a href="<?php echo $this->url(array('controller' => 'resume', 'action' => 'export-pdf', 'resume_id' => $resume->getIdentity()), 'ynresume_extended');?>"><span><i class="ynicon yn-pdf-file-o"></i> <span><?php echo $this -> translate('Save to PDF');?></span></span></a></div>
	                	<div class="ynresume-layout-list-item-action">
		                    <span><i class="ynicon yn-three-dots"></i> <span> <?php echo $this -> translate('More');?></span></span>
		                    <ul class="ynresume-show-options">
		                    	<li><?php echo $this->htmlLink(array('route'=>'ynresume_recommend','action'=>'ask'), '<i class="ynicon yn-question-circle"></i>'.$this->translate('Ask Recommendation'), array())?></li>
		                    	<li><a href="<?php echo $resume->getOwner()->getHref();?>"><i class="ynicon yn-eye"></i><?php echo $this -> translate('View Profile');?></a></li>
		                    </ul>       
	               		</div>  
	                <?php else :?>
						<div><a class='smoothbox' href="<?php echo $this->url(array('action' => 'compose-message', 'to' => $resume -> getOwner() -> getIdentity()), 'ynresume_general', true);?>"><span><i class="ynicon yn-envelope"></i> <span><?php echo $this -> translate('Message');?></span></span></a></div>

		                <div class="ynresume-layout-list-item-action">
		                    <span><i class="ynicon yn-three-dots"></i> <span> <?php echo $this -> translate('More');?></span></span>
		                    <ul class="ynresume-show-options">
								<li><a href="<?php echo $this->url(array('controller' => 'resume', 'action' => 'export-pdf', 'resume_id' => $resume->getIdentity()), 'ynresume_extended');?>"><i class="ynicon yn-pdf-file-o"></i><?php echo $this -> translate('Save to PDF');?></a></li>
								<?php if($viewer -> getIdentity() && !$viewer -> isSelf($resume -> getOwner())):?>
									<?php if($resume -> hasSkill()) :?>
										<li><a href="<?php echo $resume -> getHref();?>/endorse/1"><i class="ynicon yn-check-o-circle"></i><?php echo $this -> translate('Endorse');?></a></li>
									<?php endif;?>
										<li><a href="<?php echo $this -> url(array('action' => 'give', 'receiver_id' => $resume -> getOwner() -> getIdentity()), 'ynresume_recommend', true);?>"><i class="ynicon yn-comments"></i><?php echo $this -> translate('Recommend');?></a></li>
								<?php endif;?>
								<?php if($this -> viewer() -> getIdentity()) :?>
								<li><a id="ynresume_save_listing<?php echo $resume -> getIdentity();?>" onclick="saveResume('<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><i class="ynicon yn-floppy-disk"></i><?php echo ($resume -> hasSaved())? $this -> translate('Unsave Resume') : $this -> translate('Save Resume');?></a></li>
								<li><a href="javascript:void(0)" class="ynresume_favourite_<?php echo $resume -> getIdentity();?>" onclick="favouriteResume('<?php echo $resume -> getIdentity() ;?>');"><i class="ynicon yn-star-o"></i><?php echo ($resume -> hasFavourited()) ? $this -> translate('Unfavourite') : $this -> translate('Favourite');?></a></li>
								<?php endif;?>
								<li><a href="<?php echo $resume->getOwner()->getHref();?>"><i class="ynicon yn-eye"></i><?php echo $this -> translate('View Profile');?></a></li>
		                    </ul>       
		                </div>  
...
function saveResume(id)
{
    new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            ...
            {
                $("ynresume_save_listing"+id).set("html", '<i class="ynicon yn-floppy-disk"></i><?php echo $this -> translate("Unsave Resume");?>');
                $("ynresume-save-status-"+id).set("html", '<?php echo $this -> translate("(Saved)");?>');
            }
            else
            {
                $("ynresume_save_listing"+id).set("html", '<i class="ynicon yn-floppy-disk"></i><?php echo $this -> translate("Save Resume");?>');
        ...
        onComplete: function(responseJSON, responseText) {
            if (responseJSON.save == '1')
            {
                $$(".ynresume_favourite_"+id).each(function(el) {
                    var icon = (el.hasClass('button')) ? '' : '<i class="ynicon yn-star-o"></i>';
