        ...
        <div class="ynbusinesspages-profile-module-header">
            <div class="ynbusinesspages-profile-header-right">
                ...
                <?php if ($this->canCreate):?>
                    ...
                    ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Post New Contest'), array(
                    'class' => 'buttonlink'
                    ))
                    ?>
                <?php endif; ?>
            ...
            <li class="clearfix <?php echo ($zebra % 2) == 0? 'odd' : 'even';?>">
                ...
                <div class="ynbusinesspages-profile-module-option ">
                    ...
                    <?php if ($canPublish): ?>
                        ...
                        '<i class="ynicon yn-cloud-upload"></i>'.$this->translate('Publish'),
                        array('class'=>'buttonlink smoothbox'))
                      ?>
                    <?php endif; ?>
                    <?php if ($canRemove): ?>
                    ...
                    '<i class="ynicon yn-del"></i>'.$this->translate('Delete Contest To Business'),
                    array('class'=>'buttonlink smoothbox'))
                    ?>
                    <?php endif; ?>  
                </div>
