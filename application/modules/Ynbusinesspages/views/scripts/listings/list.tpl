            ...
            <li>
                        ...
                        <div class="ynlisting-grid-item-hover">
                            <div class="ynlisting-grid-item-hover-background">
                                <div class="listing_view_more"> 
                                    <?php echo $this->htmlLink($listing->getHref(), $this->translate('View more <span class="ynicon yn-arrow-right"></span> ') );?>
                                </div>
                ...
                <div class="ynbusinesspages-profile-module-option">
                    ...
                    <?php if ($canPublish): ?>
                        ...
                        '<i class="ynicon yn-cloud-upload"></i>'.$this->translate('Publish Listing'),
