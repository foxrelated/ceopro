        ...
        <div class="ynbusinesspages-profile-module-header">
            ...
            <div class="ynbusinesspages-profile-header-right">
                ...
                <?php if ($this->canCreate):?>
                    ...
                    ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create New Poll'), array(
                        'class' => 'buttonlink'
                    ))
                    ?>
                <?php endif; ?>
                ...
                <div class="ynbusinesspages-profile-module-option">
                    ...
                    <?php if ($canEdit): ?>
                        ...
                        array(
                            ...
                            'parent_type' => 'ynbusinesspages_business',
                        ), '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Poll'), array(
                            'class' => 'buttonlink',
                        ))
                        ?>
                    <?php endif; ?>
                    <?php if ($canDelete): ?>
                        ...
                        '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Poll'),
                    ...
                    <?php if ($canRemove): ?>
                        ...
                        '<i class="ynicon yn-del"></i>'.$this->translate('Delete Poll To Business'),
                        array('class'=>'buttonlink smoothbox'))
                        ?>
                    <?php endif; ?>  
                    <?php endif; ?>
