	...
	arr_days.forEach(function(entry) {
  	...
  	function addMoreAddLocation(obj, e, index_location) {
        ...
        var remove = new Element('a', {
            ...
            html: '',
            'class': 'ynicon yn-minus-circle remove-add-location',
            events : {
    ...
    if ($('add_more_category')) {
  	...
  	function addMoreAddCategory(obj, e) {
        ...
        var remove = new Element('a', {
            href: 'javascript:void(0)',
            html: '',
            'class': 'ynicon yn-minus-circle remove-add-category',
            events : {
                click: function(event) {
                    event.preventDefault();
  	...
  	function addMoreAddPhone(obj, e) {
        ...
        var remove = new Element('a', {
            href: 'javascript:void(0)',
            html: '',
            'class': 'ynicon yn-minus-circle remove-add-phone',
            events : {
                click: function(event) {
                    event.preventDefault();
                    this.getParent('.form-wrapper').destroy();
  	...
  	function addMoreAddFax(obj, e) {
        ...
        var remove = new Element('a', {
            href: 'javascript:void(0)',
            html: '',
            'class': 'ynicon yn-minus-circle remove-add-fax',
            events : {
                click: function(event) {
                    event.preventDefault();
                    this.getParent('.form-wrapper').destroy();
  	...
  	function addMoreAddWebAddress(obj, e) {
        ...
        var remove = new Element('a', {
            href: 'javascript:void(0)',
            html: '',
            'class': 'ynicon yn-minus-circle remove-add-web_address',
            events : {
                click: function(event) {
                    event.preventDefault();
                    this.getParent('.form-wrapper').destroy();
