  ...
  <div class="generic_layout_container layout_middle">
    ...
    <div class="ynbusinesspages-profile-module-header">
        ...
        <div class="ynbusinesspages-profile-header-right">
          <?php echo $this->htmlLink(array('route' => 'ynbusinesspages_profile', 'id' => $this->business->getIdentity(), 'tab' => $this -> tab), '<i class="ynicon yn-arrow-left"></i>'.$this->translate('Back to Business'), array(
            'class' => 'buttonlink'
          )) ?>
          <?php if ($this->can_post) { echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller' => 'topic', 'action' => 'create', 'business_id' => $this->business->getIdentity()), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Post New Topic'), array(
            'class' => 'buttonlink'
          )); }?>
        </div>      
    </div>  
