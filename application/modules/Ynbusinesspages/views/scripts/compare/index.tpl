        ...
        <div id="compare-fields-content-div">
            ...
            <?php foreach ($this->businesses as $business) :?>
                <li id="compare-business_<?php echo $business->getIdentity()?>">
                    <div class="delete">
                        <a href="javascript:void(0)" onclick="deleteComparebusiness2(this, <?php echo $business->getIdentity();?>, <?php echo $this->category->getIdentity();?>)"><i class="ynicon yn-del"></i></a>
                    </div>
