...
<div class="ynvideochannel_video_options">
    <span class="ynvideochannel_video_options-btn"><i class="ynicon yn-gear" aria-hidden="true"></i></span>
    ...
    <?php if($this -> unfavorite) :?>
        <li>
            <?php echo $this->htmlLink(array(
                ...
                'video_id' => $item->getIdentity(),
                'format' => 'smoothbox'
                ), '<i class="ynicon yn-del" aria-hidden="true"></i>', array('class' => 'smoothbox icon_ynvideochannel_unfavorite', 'title'=>$this->translate('Un-favorite')));
            ?>
        </li>
    <?php else: ?>
    <?php if ($item->authorization()->isAllowed($viewer, 'edit')):?>
...
"></i>', array('class' => 'smoothbox icon_ynvideochannel_delete', 'title'=>$this->translate('Delete video')));
            ?>
        </li>
    <?php endif ?>
    <?php endif ?>
