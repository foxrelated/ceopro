	...
	<div class="generic_layout_container layout_middle">
        ...
        <div class="ynbusinesspages-profile-module-header">
            <div class="ynbusinesspages-profile-header-right">
                <?php echo $this->htmlLink(array('route' => 'ynbusinesspages_profile', 'id' => $this->business->getIdentity(), 'slug' => $this->business-> getSlug(), 'tab' => $this -> tab), '<i class="ynicon yn-arr-left"></i>'.$this->translate('Back to Business'), array(
                'class' => 'buttonlink'
                )) ?>
                ...
                <?php if ($this->canCreate):?>
                    ...
                    ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create New Listing'), array(
                    'class' => 'buttonlink'
                    ))
                    ?>
                <?php endif; ?>
                ...
                <div class="ynbusinesspages-profile-module-option ">
                    <?php if ($canEdit): ?>
                        ...
                        array(
                            ...
                            'parent_type' => 'ynbusinesspages_business',
                        ), '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Listing'), array(
                            'class' => 'buttonlink',
                        ))
                        ?>
                    <?php endif; ?>
                    <?php if ($canDelete): ?>
                        ...
                        '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Listing'),
                    ...
                    <?php if ($canRemove): ?>
                        ...
                        '<i class="ynicon yn-del"></i>'.$this->translate('Delete Listing To Business'),
                        array('class'=>'buttonlink smoothbox'))
                        ?>
                    <?php endif; ?> 
                </div>
