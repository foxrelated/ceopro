            ...
            <div class="ynbusinesspages-profile-header-right">
				...
				<?php if ($this->canCreate):?>
					<?php if ($this->ItemTable == 'music_playlist'): ?>
						...
						), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create Playlist'), array(
						'class' => 'buttonlink'
						))
						?>
					<?php else: ?> 	
						...
						'business_id' => $this->business->getIdentity(),
	                    'parent_type' => 'ynbusinesspages_business',
						), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create Album'), array(
						'class' => 'buttonlink'
						))?>
					<?php endif; ?>
				<?php endif; ?>      
			...
			<li id="music_playlist_item_<?php echo $playlist->getIdentity() ?>">
				...
				<div class="ynbusinesspages-profile-module-option">
                    ...
                    <?php if ($canEdit): ?>
                          ...
                          $playlist->getHref(
                            array('route' => 'music_playlist_specific', 
                                ...
                                'parent_type' => 'ynbusinesspages_business')),
                                '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Playlist'),
                    ...
                    <?php if ($canDelete): ?>
                        ...
                        '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Playlist'),
                    ...
                    <?php if ($canRemove): ?>
                        ...
                        '<i class="ynicon yn-del"></i>'.$this->translate('Delete Playlist To Business'),
                        array('class'=>'buttonlink smoothbox'))
                        ?>
                    <?php endif; ?> 
                    <?php endif; ?>
			...
			<li id="mp3music_album_item_<?php echo $album->getIdentity() ?>">
				...
				<div class="ynbusinesspages-profile-module-option">
                        ...
                        <?php echo $this->htmlLink($album->getEditHref($params),
                            '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit'),
                            array('class'=>'buttonlink'
                            )) ?>
                        <?php endif; ?>
                        <?php if ($canDelete): ?>
                        <?php echo $this->htmlLink($album->getDeleteHref($params),
                            '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete'),
                            array('class'=>'buttonlink smoothbox'
                        )) ?>
                        <?php endif; ?>
                        <?php if ($canRemove): ?>
                        <?php echo $this->htmlLink(array(
                            ...
                            'remove_action' => 'music_delete',
                            'business_id' => $business->getIdentity(),
                        ),'<i class="ynicon yn-del"></i>'.$this->translate('Delete Album To Business'),
                        array('class'=>'buttonlink smoothbox'))
                        ?>
                    <?php endif; ?> 
                <?php endif; ?>
