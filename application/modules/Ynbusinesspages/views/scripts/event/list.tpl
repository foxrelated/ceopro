		...
		<div class="generic_layout_container">
			...
			<div class="ynbusinesspages-profile-module-header">
	            <div class="ynbusinesspages-profile-header-right">
		            ...
		            <?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'event','action'=>'manage','subject' => $this->subject()->getGuid()), '<i class="ynicon yn-user"></i>'.$this->translate('My Events'), array(
						'class' => 'buttonlink'
					)) ?>
			...
			<?php if ($this->paginator->getTotalItemCount()> 0) : ?>
	   		<ul class='ynbusinesspages_event_browse yn-clearfix'>
