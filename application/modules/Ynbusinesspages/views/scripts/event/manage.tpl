	...
	<div class="generic_layout_container layout_middle">
		...
		<div class="ynbusinesspages-profile-module-header">
            <div class="ynbusinesspages-profile-header-right">
				...
				<?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'event','action'=>'list','subject' => $this->subject()->getGuid()), '<i class="ynicon yn-list-view"></i>'.$this->translate('Browse Events'), array(
					'class' => 'buttonlink'
				)) ?>
				...
				<?php echo $this->htmlLink(array(
				  ...
				  ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Create New Event'), array(
					'class' => 'buttonlink'
				)) ?>
				<?php endif; ?>
            </div>
        ...
        <?php foreach ($this->paginator as $event): ?>
        	<li class="ynbusinesspages_profile_event_item">
				...
				<div class="ynbusinesspages-profile-module-option ">
					...
					if ($canEdit): ?>
					<?php
						echo $this->htmlLink(array('route' => 'event_specific', 'action' => 'edit', 'event_id' => $event->getIdentity(), 'business_id' => $this->business->business_id, 'parent_type' => 'ynbusinesspages_business'), '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Event'), array(
						'class' => 'buttonlink'
						))
					?>
					<?php endif; ?>
					<?php if ($canDelete): ?>
					<?php
						echo $this->htmlLink(array('route' => 'default', 'module' => 'event', 'controller' => 'event', 'action' => 'delete', 'event_id' => $event->getIdentity(), 'business_id' => $this->business->business_id, 'parent_type' => 'ynbusinesspages_business', 'format' => 'smoothbox'), '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Event'), array(
					...
					<?php echo $this->htmlLink(array(
                        ...
                        ), '<i class="ynicon yn-del"></i>'.$this->translate('Delete Event to Business'),
