	...
	<div class="generic_layout_container layout_middle">
		...
		<div class="ynbusinesspages-profile-module-header">
            ...
            <div class="ynbusinesspages-profile-header-right">
				...
				<?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'ultimate-video','action'=>'list','subject' => $this->subject()->getGuid()), '<i class="ynicon yn-list-view"></i>'.$this->translate('Browse Videos'), array(
                ...
                <div class="ynbusinesspages-profile-module-option">
                	...
                	if($canEdit)
					{
						echo $this->htmlLink(array(
							...
							'parent_type' => 'ynbusinesspages_business',
							), '<i class="ynicon yn-pencil-square-o"></i>'.$this->translate('Edit Video'), array('class' => 'buttonlink'));
					}
					?>
                    ...
                    if($canDelete)
					{
	                    if ($item->status != 2) {
							echo $this->htmlLink(array(
								...
								'format' => 'smoothbox'
								), '<i class="ynicon yn-trash-o"></i>'.$this->translate('Delete Video'), array('class' => 'buttonlink smoothbox'));
						}
					}
					if($canDeleteToBusiness)
					{
                        ...
                        '<i class="ynicon yn-del"></i>'.$this->translate('Delete Video to Business'),
