		...
		<!-- Menu Bar -->
            ...
            <!-- Menu Bar -->
            	<div class="ynbusinesspages-profile-header-right">
					...
					<?php echo $this->htmlLink(array('route' => 'ynbusinesspages_extended', 'controller'=>'ultimate-video','action'=>'manage','subject' => $this->subject()->getGuid()), '<i class="ynicon yn-user"></i>'.$this->translate('Manage Videos'), array(
					'class' => 'buttonlink'
					)) ?>
