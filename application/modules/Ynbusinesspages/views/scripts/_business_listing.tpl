...
<div class="ynbusinesspages-business-listing-header ynbusinesspages-clearfix">
	...
	<div id="ynbusinesspages-business-mode-view-<?php echo $this -> idName; ?>" class="ynbusinesspages-business-mode-view">
		<?php if(in_array('list', $this -> mode_enabled)):?>
			<span class="ynbusinesspages-viewmode-list ynicon yn-list-view" rel="ynbusinesspages-browse-business-viewmode-list"></span>
		<?php endif;?>
		<?php if(in_array('grid', $this -> mode_enabled)):?>
			<span class="ynbusinesspages-viewmode-grid ynicon yn-grid-view" rel="ynbusinesspages-browse-business-viewmode-grid"></span>
		<?php endif;?>	
        <?php if(in_array('pin', $this -> mode_enabled)):?>
            <span class="ynbusinesspages-viewmode-pins ynicon yn-pin-view" rel="ynbusinesspages-browse-business-viewmode-pins"></span>
        <?php endif;?>  
		<?php if(in_array('map', $this -> mode_enabled)):?>
			<span class="ynbusinesspages-viewmode-maps ynicon yn-map-marker" rel="ynbusinesspages-browse-business-viewmode-maps"></span>
		<?php endif;?>	
	</div>
</div>
	...
	<div class="ynbusinesspages-business-listing-item">
	    <div class="ynbusinesspages-business-listing-item-header">
            ...
            <div class="ynbusinesspages-business-listing-item-category">
                <i class="ynicon yn-folder-open-o"></i>
		...
		<div class="ynbusinesspages-business-listing-item-content">
            ...
            <?php if ($review_count < 1):?>
                ...
                <span class="review-link">
                    ...
                    ), '<i class="ynicon yn-pencil-square-o"></i><span>'.$this->translate('No reviews. Be the first!').'</span>'
                    , array (
                        'class' => 'smoothbox'
                    ))?>
                </span>
            ...
            <?php else : ?>
                ...
                <span class="review-link">
                    <?php echo $this->htmlLink(array(
                        ...
                        'refresh' => true,
                        'business_id' => $business->getIdentity(),
                    ), '<i class="ynicon yn-pencil-square-o"></i><span>'.$this->translate('Write a review!').'</span>'
                    , array (
                        'class' => 'smoothbox'
                    ))?>
                </span>
            ...
            <div class="ynbusinesspages-business-listing-item-claim">
                <i class="ynicon yn-paper-plane"></i>
                ...
                <?php if (Engine_Api::_()->ynbusinesspages()->isMobile()) : ?>
                    ...
                    <?php if (count($phones) < 1 || $phones[0] == '') : ?>
                        <a href="javascript:void(0)" onclick="noInfoPopup('<?php echo $this->translate('Call us')?>')">
                            <i class="ynicon yn-phone-ring"></i>
                ...
                <?php if (Engine_Api::_()->ynbusinesspages()->isMobile()) : ?>
                    ...
                    <?php if ($mainLocations) : ?>
                        ...
                        <a href="<?php echo $url?>" class="get_direction smoothbox">
                            <i class="ynicon yn-location-arrow"></i>
...
<script type="text/javascript">
    ...
    function setMapMode<?php echo $this->idPrefix;?>(){
        ...
        iframe.inject( $$('#ynbusinesspages-business-listing-maps-<?php echo $this->idName;?>')[0] );
