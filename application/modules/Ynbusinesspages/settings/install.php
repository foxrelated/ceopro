	...
	protected function _addBusinessDetailPage() {
        ...
        if(!$page_id) {
            ...
            $db->insert('engine4_core_content', array(
                ...
                'parent_content_id' => $main_container_id,
                'order' => 21,
                'params' => '{"title":"VideoChannel Video", "titleCount": true}',
            ));

            //Insert profile Employees widget
            $db->insert('engine4_core_content', array(
                'type' => 'widget',
                ...
                'parent_content_id' => $main_container_id,
                'order' => 22,
                'params' => '{"title":"Employees", "titleCount": true}',
            ));

            //Insert profile Students and Alumni widget
            $db->insert('engine4_core_content', array(
                'type' => 'widget',
                ...
                'parent_content_id' => $main_container_id,
                'order' => 23,
                'params' => '{"title":"Students and Alumni", "titleCount": true}',
            ));
        }
    }
