...
('ynbusinesspages', 'album_create', 'Create Albums', '0', 1, 1, 0, 0),
('ynbusinesspages', 'album_delete', 'Delete Albums to Business', '1', 1, 1, 0, 0),
...
('ynbusinesspages_main', 'standard', 'YNC - Business Main Navigation Menu', 999);

-- insert back-end menu items
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
('core_admin_main_plugins_ynbusinesspages', 'ynbusinesspages', 'YNC - Business', '', '{"route":"admin_default","module":"ynbusinesspages","controller":"settings", "action":"global"}', 'core_admin_main_plugins', '', 999),
...
('ynbusinesspages_main_create_business', 'ynbusinesspages', 'Create', 'Ynbusinesspages_Plugin_Menus', '{"route":"ynbusinesspages_general","controller":"index","action":"create"}', 'ynbusinesspages_main', '', 1, 0, 4),
('ynbusinesspages_main_faqs', 'ynbusinesspages', 'FAQs', '', '{"route":"ynbusinesspages_extended","controller":"faqs","action":"index"}', 'ynbusinesspages_main', '', 1, 0, 5);
