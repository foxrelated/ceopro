...
// Friends & Followers resources
    ...
    public function followersList(
        $userId = null, $count = 20, $screenName = null, $cursor = null,
        $includeEntities = null, $skipStatus = null
    )
    {
        // validate
...
// OAuth resources
    ...
    public function oAuthRequestToken($callbackURL = null)
    {
        ...
        if (!isset($response['oauth_token'], $response['oauth_token_secret'])) {
            echo 'The Twitter App key not found. Make sure that you have entered the correct Twitter App Key. Please check again';
            exit();
        }
