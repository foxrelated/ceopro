INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('ynresponsivepurity', 'YNC - Responsive Purity Template', 'Responsive Purity Template', '4.02p1', 1, 'extra') ;
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
('core_admin_main_plugins_ynresponsivepurity', 'ynresponsivepurity', 'YNC - Responsive Purity', '', '{"route":"admin_default","module":"ynresponsivepurity","controller":"manage-slider"}', 'core_admin_main_plugins', '', 999);
