...
class Ynresponsive1_BootHelper extends Zend_Controller_Action_Helper_Abstract
{
	...
	*/
	public function postDispatch()
	{
        ...
        if ( YNRESPONSIVE_ACTIVE == "ynresponsive-event" ) 
        {
            $view -> headLink() -> appendStylesheet($protocol.'fonts.googleapis.com/css?family=Oswald:300&subset=latin,latin-ext');
        }
		...
		else if(substr(YNRESPONSIVE_ACTIVE, 0, 20) != 'ynresponsivebusiness')
		{
			$view -> headLink() -> appendStylesheet($protocol.'fonts.googleapis.com/css?family=Poppins:300,400,500,600,700');
		}
		else
		{
		...
		$view -> headLink() -> appendStylesheet($staticUrl . 'application/css.php?request=application/themes/'.YNRESPONSIVE_ACTIVE.YNRESPONSIVE_THEME_FOLDER.'/yntheme.css');
		$view -> headLink() -> appendStylesheet($staticUrl . 'application/css.php?request=application/themes/'.YNRESPONSIVE_ACTIVE.YNRESPONSIVE_THEME_FOLDER.'/yncustom.css');
		$view -> headLink() -> appendStylesheet($staticUrl . 'application/css.php?request=application/themes/'.YNRESPONSIVE_ACTIVE.YNRESPONSIVE_THEME_FOLDER.'/yncustom-mobile.css');
		...
		{
			$view -> headLink() -> appendStylesheet($staticUrl . 'application/css.php?request=application/themes/'.YNRESPONSIVE_ACTIVE.YNRESPONSIVE_THEME_FOLDER.'/yncustom-homepage.css');
		}
