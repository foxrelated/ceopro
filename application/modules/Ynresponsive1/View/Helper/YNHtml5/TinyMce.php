...
class Ynresponsive1_View_Helper_YNHtml5_TinyMce extends Zend_View_Helper_Abstract
{
    ...
    {
        $direction = $this->_config['directionality'];
        $stylesheets = "['".$this->view->baseUrl() . "/application/themes/" . YNRESPONSIVE_ACTIVE . "/editor.css']";
        if ($direction == 'rtl') {
            $stylesheets = "['" . $this->view->baseUrl() . "/application/themes/" . YNRESPONSIVE_ACTIVE . "/editor.css','" . $this->view->baseUrl() . "/application/modules/Ynresponsive1/externals/styles/editor_rtl.css']";
            $this->view->headLink() -> prependStylesheet($this->view->baseUrl() . "/application/modules/Ynresponsive1/externals/styles/editor_rtl.css");
        }
