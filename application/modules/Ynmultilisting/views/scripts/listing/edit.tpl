  ...
  window.addEvent('domready', function() {
	...
	if($$('.item-form-theme-choose').length > 0)
	{
  	...
  	$$('.btn-preview-theme').addEvent('click', function(){
		...
		var mypreview = new Element('div', {html: '<div class="preview-overlay"></div><div class="preview-main"><span class="btn-preview-popup-close ynicon yn-del-thin"></span><img src="'+ data_img + '" /></div>'});
