...
<div class="admin_fields_type">
  ...
  <div>
    ...
    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'category', 'action' => 'index'), $this->translate($node->shortTitle()), array()) ?>
    &raquo;
    <?php endforeach; ?>
    <strong><?php
            if(count($this->category->getBreadCrumNode()) > 0):
      echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'ynmultilisting', 'controller' => 'category', 'action' => 'index', 'parent_id' =>$this->category->category_id), $this->translate($this->category->shortTitle()), array());
      else:
