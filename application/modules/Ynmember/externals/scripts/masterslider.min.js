...
;(function($){
	...
	Function.prototype.my_extend = function(superclass){
		if(typeof superclass.prototype.constructor === "function"){
			extend(this.prototype , superclass.prototype);
			this.prototype.constructor = this;
		}else{
			this.prototype.my_extend(superclass);
			this.prototype.constructor = this;
		}
	};
...
;(function(){
	...
	averta.EventDispatcher.my_extend = function(_proto){
...
;(function($){
	...
	MSImageLayerElement.my_extend(MSLayerElement);
...
;(function($){
	...
	MSVideoLayerElement.my_extend(MSLayerElement);
...
;(function($){
	...
	MSHotspotLayer.my_extend(MSLayerElement);
...
(function($){
	...
	MSButtonLayer.my_extend(MSLayerElement);
...
;(function($){
	...
	averta.EventDispatcher.my_extend(p);
})(jQuery);
...
;(function($){
	...
	MSWaveView.my_extend(MSBasicView);
...
;(function(){
	...
	MSFadeBasicView.my_extend(MSWaveView);
...
;(function(){
	...
	MSFadeWaveView.my_extend(MSWaveView);
...
;(function($){
	...
	MSFlowView.my_extend(MSWaveView);
...
;(function(){
	...
	MSFadeFlowView.my_extend(MSWaveView);
...
;(function($){
	...
	MSMaskView.my_extend(MSBasicView);
...
;(function($){
	...
	MSFadeView.my_extend(MSBasicView);
...
;(function($){
	...
	MSScaleView.my_extend(MSFadeView);
...
;(function(){
	...
	MSFocusView.my_extend(MSWaveView);
...
;(function(){
	...
	MSPartialWaveView.my_extend(MSWaveView);
...
;(function($){
	...
	MSArrows.my_extend(BaseControl);
...
;(function($){
	...
	MSThumblist.my_extend(BaseControl);
...
;(function($){
	...
	MSBulltes.my_extend(BaseControl);
...
;(function($){
	...
	MSScrollbar.my_extend(BaseControl);
...
;(function($){
	...
	MSTimerbar.my_extend(BaseControl);
...
;(function($){
	...
	MSCircleTimer.my_extend(BaseControl);
...
;(function($){
	...
	MSLightbox.my_extend(BaseControl);
...
;(function($){
	...
	MSSlideInfo.my_extend(BaseControl);
	...
	p.switchEle = function(ele){
		if(this.current_ele){
			...
			// console.log(this.current_ele[0].tween);
