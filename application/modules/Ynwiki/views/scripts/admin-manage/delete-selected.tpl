...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Trash the selected page(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to trash the %d page(s)? ", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Trash the selected page(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Please select a page to trash.") ?> 
      </p>
      <br/>
