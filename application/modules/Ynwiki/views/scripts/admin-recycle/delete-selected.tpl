...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Delete the selected page(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to delete the %d page(s)? It will not be recoverable after being deleted.", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Delete the selected page(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Please select a page to delete.") ?> 
      </p>
      <br/>
