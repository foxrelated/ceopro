...
class Ynwiki_Form_Faqs_Admin_Create extends Engine_Form {
    ...
    $this->addElement('Cancel', 'cancel', array(
      ...
      'link' => true,
      'prependText' => ' or ',
      'href' => Zend_Controller_Front::getInstance()->getRouter()->assemble(array('module'=>'ynwiki','action'=>'index','controller'=>'faqs'), 'admin_default', true),
      'onclick' => '',
      'decorators' => array(
        'ViewHelper',
      ),
