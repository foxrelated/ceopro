<?php
class Ynwiki_Model_DbTable_Membership extends Core_Model_DbTable_Membership
{
  protected $_type = 'ynwiki_page';
  protected $_name = 'ynwiki_membership';
...
//   	if ($row === null)
//   	{	  		
//   		 $rootpage = $resource->getRootParent($resource->page_id);  		 
//   		 if($rootpage !==null)  		 
//   		 	return $rootpage->  membership() -> isMember($user);
//   		 else 
//   		 	return false;  		 			
//   	}  
//   	if( null === $active )
