INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('ynfeed', 'YNC - Advanced Feed', 'This is advanced feed plugin.', '4.01', 1, 'extra') ;
...
('core_admin_main_plugins_ynfeed', 'ynfeed', 'YNC - Advanced Feed', '', '{"route":"admin_default","module":"ynfeed","controller":"settings"}', 'core_admin_main_plugins', '', 999),
