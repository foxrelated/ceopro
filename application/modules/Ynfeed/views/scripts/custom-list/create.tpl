<div class="ynfeed_popup">
	...
	<div class="ynfeed_popup_options">
		...
		<div id="list_title-element" class="ynfeed_popup_options_left">
			<input type='text' class='text suggested' name='title' id='list_title' onkeypress="javascript:if(document.getElementById('validation_title')){ document.getElementById('list_title-element').removeChild(document.getElementById('validation_title'));}" size='50' maxlength='100' placeholder='<?php echo $this->translate('Enter List Title...') ?>' />
		</div>
	  ...
	  <div class="ynfeed_popup_options_right">
	    <input type='text' class='ynfeed_popup_searchbox suggested' name='search' id='field_search' size='20' maxlength='100' placeholder='<?php echo $this->translate('Search') ?>' onkeyup="getContentItem(1)" />
	  </div>
	</div>
