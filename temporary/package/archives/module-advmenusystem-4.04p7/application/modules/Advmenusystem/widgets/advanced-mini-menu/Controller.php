...
class Advmenusystem_Widget_AdvancedMiniMenuController extends Engine_Content_Widget_Abstract
{
	public function indexAction()
	{
		...
		$this -> view -> login_captcha_required = Engine_Api::_()->getApi('settings', 'core')->core_spam_login;
		$this -> view -> signup_captcha_required = Engine_Api::_()->getApi('settings', 'core')->core_spam_signup;
