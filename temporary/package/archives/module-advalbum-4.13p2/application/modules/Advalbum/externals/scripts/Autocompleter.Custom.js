	...
	choiceSelect: function(choice) {
        ...
        doPushSpan: function(name, toID, newItem, hideLoc, list, url){
          ...
          if (newItem){
            ...
            myElement.innerHTML = name + " <a class='ynicon yn-del' href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\""+toID+"\", \""+hideLoc+"\");'></a>";
          }
          else{
            myElement.id = "tospan_"+name+"_"+toID;
            myElement.innerHTML = name + " <a class='ynicon yn-del' href='javascript:void(0);' onclick='this.parentNode.destroy();removeFromToValue(\""+toID+"\", \""+hideLoc+"\");'></a>";
          ...
          myElement.inject(this.element, 'before');
          this.fireEvent('push');
        },
		...
		// allow tag the same person to multi photos
          if ($(this.options.toElementName + '-element').getChildren('span[id=' + span_id + ']').length){
            return false;
          }
          else return true;
        },
